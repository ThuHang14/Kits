 ...
 */
package collections.collections.compareAndSort;
...
public class SortEmployee2 {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        if (i >= 0) {
            ...
            System.out.println("Không tìm thấy " + employee.toString());
        ...
        i = Collections.binarySearch(listEmployees, employee, new EmployeeComparator());
        if (i >= 0) {
            System.out.println("Tìm thấy " + employee.toString() + "   ở vị trí:" + i);
