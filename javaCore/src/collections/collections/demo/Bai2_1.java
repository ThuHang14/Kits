 ...
 */
package collections.collections.demo;
...
public class Bai2_1 {
    ...
    public static void main(String[] agrs) throws ParseException {
        ...
        Optional<Map.Entry<Order, ArrayList<OrderDetail>>> tt = str1
                .max((x, y) -> new Integer(x.getValue().stream().mapToInt(x1 -> x1.getAmount()).sum())
