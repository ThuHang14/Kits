...
public interface EmployeeDao {
    ...
    public List<Employee> getEmployeeByName(String name); //Dùng cho TRUY VẤN (SELECT)
    public List<Employee> getEmployeeByEmail(String email); //Dùng cho TRUY VẤN (SELECT)
